...
bonds = tuple(float_args[-9:-5])
angles = tuple(float_args[-5:])
print(len(float_args))
error = run_MM(float_args[0], float_args[1],float_args[2],float_args[3],float_args[4],float_args[5],float_args[6],float_args[7], bonds, angles)
print(error)
